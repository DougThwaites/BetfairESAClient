...
/**
 * MarketSubscriptionMessage Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MarketSubscriptionMessage extends RequestMessage implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'MarketSubscriptionMessage';
    ...
    protected static $swaggerTypes = array(
        ...
        'heartbeat_ms' => 'int',
        'initial_clk' => 'string',
        'market_filter' => '\Swagger\Client\Model\MarketFilter',
        'conflate_ms' => 'int',
        'market_data_filter' => '\Swagger\Client\Model\MarketDataFilter'
    );
    ...
    protected static $setters = array(
        ...
        'market_filter' => 'setMarketFilter',
        'conflate_ms' => 'setConflateMs',
        'market_data_filter' => 'setMarketDataFilter'
    );
    ...
    protected static $getters = array(
        ...
        'market_filter' => 'getMarketFilter',
        'conflate_ms' => 'getConflateMs',
        'market_data_filter' => 'getMarketDataFilter'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['market_filter'] = isset($data['market_filter']) ? $data['market_filter'] : null;
        $this->container['conflate_ms'] = isset($data['conflate_ms']) ? $data['conflate_ms'] : null;
        $this->container['market_data_filter'] = isset($data['market_data_filter']) ? $data['market_data_filter'] : null;
    }
    ...
    /**
     * Gets market_filter
     * @return \Swagger\Client\Model\MarketFilter
     */
    public function getMarketFilter()
    {
        return $this->container['market_filter'];
    }

    /**
     * Sets market_filter
     * @param \Swagger\Client\Model\MarketFilter $market_filter
     * @return $this
     */
    public function setMarketFilter($market_filter)
    {
        $this->container['market_filter'] = $market_filter;
    ...
    /**
     * Gets market_data_filter
     * @return \Swagger\Client\Model\MarketDataFilter
     */
    public function getMarketDataFilter()
    {
        return $this->container['market_data_filter'];
    }

    /**
     * Sets market_data_filter
     * @param \Swagger\Client\Model\MarketDataFilter $market_data_filter
     * @return $this
     */
    public function setMarketDataFilter($market_data_filter)
    {
        $this->container['market_data_filter'] = $market_data_filter;
